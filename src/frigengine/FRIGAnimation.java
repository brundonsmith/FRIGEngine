...
public class FRIGAnimation extends IDable<String> implements Initializable {
	...
	public FRIGAnimation copy() {
		FRIGAnimation copy = new FRIGAnimation();
