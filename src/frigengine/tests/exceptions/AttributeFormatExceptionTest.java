...
public class AttributeFormatExceptionTest {
	...
	private static AttributeFormatException ex = new AttributeFormatException(ELEMENT_NAME,
			ATTRIBUTE_NAME, GIVEN_VALUE);

	@Test
	public void testGetMessage() {
		Assert.assertEquals("Attribute '" + ATTRIBUTE_NAME + "' in XML element '" + ELEMENT_NAME
				+ "' was given invalid value '" + GIVEN_VALUE + "'", ex.getMessage());
	}
