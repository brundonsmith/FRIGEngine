...
public class ComponentScriptable extends EntityComponent {
	...
	private void positionEntity(String x, String y) {
		...
		((ComponentSpacial) this.entity.getComponent(ComponentSpacial.class)).moveTo(parsedX, parsedY);
	}
	...
	public static Set<Class<?>> getComponentDependencies() {
		return new HashSet<Class<?>>( Arrays.asList( new Class<?>[] {ComponentCharacter.class}) );
	}
